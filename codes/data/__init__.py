...
def create_dataset(dataset_opt):
    ...
    elif mode == 'video_test_lmdb':
        from data.val_with_lmdb import VideoTestLmdbDataset as D
    elif mode == 'unlmdb':
        from data.train_without_lmdb_dataset import MyDataset as D
    elif mode == 'my_test':
        from data.my_test_dataset import my_test_dataset as D
    else:
