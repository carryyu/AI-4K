...
def main():
    dataset = 'my_dataset'  # vimeo90K | REDS | general (e.g., DIV2K, 291) | DIV2K_demo |test
    mode = 'GT_RESIZE'  # used for vimeo90k and REDS datasets
    # vimeo90k: GT | LR | flow
...
def my_dataset(mode):
    ...
    BATCH = 5000  # After BATCH images, lmdb commits, if read_all_imgs = False
    if mode == 'GT':
        img_folder = '../../datasets/pngs/gt'
        lmdb_save_path = '../../datasets/pngs/my_dataset_gt.lmdb'
        H_dst, W_dst = 2160, 3840
    elif mode == 'LR':
        img_folder = '../../datasets/pngs/input'
        lmdb_save_path = '../../datasets/pngs/my_dataset_input.lmdb'
        H_dst, W_dst = 540, 960
    elif mode == 'GT_RESIZE':
        img_folder = '../../datasets/pngs/gt_resize'
        lmdb_save_path = '../../datasets/pngs/my_dataset_gt_resize.lmdb'
        H_dst, W_dst = 540, 960
    n_thread = 40
    ########################################################
    if not lmdb_save_path.endswith('.lmdb'):
...
def vimeo90k(mode):
    ...
    if mode == 'GT':
        ...
        img_folder = '../../datasets/input'
        lmdb_save_path = '../../datasets/my_dataset_input.lmdb'
        # txt_file = '../../datasets/vimeo90k/vimeo_septuplet/sep_trainlist.txt'
        txt_file = '../../datasets/train_input.txt'
        H_dst, W_dst = 540, 960
    elif mode == 'flow':
