...
def main():
    dataset = '1'  # REDS | Vimeo90K | DIV2K800_sub
    opt = {}
    opt['dist'] = False
    opt['gpu_ids'] = [0]
    if dataset == 'my_dataset':
        opt['name'] = 'unlmdb'
        opt['dataroot_GT'] = '/home/lzy/Downloads/EDVR-master/datasets/pngs/gt'
        opt['dataroot_LQ'] = '/home/lzy/Downloads/EDVR-master/datasets/pngs/input'
        opt['mode'] = 'unlmdb'
        opt['N_frames'] = 5
        ...
        opt['name'] = 'my_dataset'
        opt['dataroot_GT'] = '/home/lzy/Downloads/EDVR-master/datasets/pngs/my_dataset_gt.lmdb'
        opt['dataroot_LQ'] = '/home/lzy/Downloads/EDVR-master/datasets/pngs/my_dataset_input.lmdb'
        opt['mode'] = 'REDS'
        opt['N_frames'] = 5
        opt['cache_data'] = False
        opt['phase'] = 'train'
    ...
    for i, data in enumerate(train_loader):
        if i > 5:
            break
        print(i)
        if dataset == 'REDS' or dataset == 'Vimeo90K' or dataset == 'my_dataset':
            LQs = data['LQs']
        else:
            LQ = data['LQ']
        GT = data['GT']
