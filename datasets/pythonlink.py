...
distpath_gt = '/home/lzy/Downloads/EDVR-master/datasets/all_data/gt'
distpath_input = '/home/lzy/Downloads/EDVR-master/datasets/all_data/input'
distpath_test = '/home/lzy/Downloads/EDVR-master/datasets/test_data'
distpath_gt_resize = '/home/lzy/Downloads/EDVR-master/datasets/all_data/gt_resize'
distpath_test_deblur = '/home/lzy/Downloads/EDVR-master/datasets/test_data_deblur'
...
for name in folder_name:
    os.symlink(os.path.join(sour, name+'.mp4'), os.path.join(dist, name+'.mp4'))